    ...
    public static class SeederDb
    {
        public static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Sector>().HasData(
                new Sector { Id = 1, Name = "Distrito Nacional", Code = "DN", MunicipalityId = 1, CreatedAt = DateTime.UtcNow, IsActive = true },
                new Sector { Id = 2, Name = "Santo Domingo Este", Code = "SDE", MunicipalityId = 1, CreatedAt = DateTime.UtcNow, IsActive = true },
                new Sector { Id = 3, Name = "Santo Domingo Norte", Code = "SDN", MunicipalityId = 1, CreatedAt = DateTime.UtcNow, IsActive = true },
                new Sector { Id = 4, Name = "Santo Domingo Oeste", Code = "SDO", MunicipalityId = 1, CreatedAt = DateTime.UtcNow, IsActive = true }
            );
